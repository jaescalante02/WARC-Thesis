-- segment_insert_WAR.sql
--
-- Procedimiento que incluye un segmento a la base de datos con la tecnica WAR.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE segment_insert_WAR(pid in number, url in varchar, 
...
/
SHOW ERRORS PROCEDURE segment_insert_WAR;
