...
-- en la base de datos con la técnica WIT.
-- Autores:
--
-- Samantha Campisi (samanthac07@gmail.com)
-- Juan A. Escalante (jaescalante02@gmail.com)

CREATE OR REPLACE PROCEDURE page_insert_WIT(pid in number, url in varchar, 
    ...
    BEGIN
        ...
        insert into WIT_PAGINA (P_ID, P_URL)
        values (pid, url);
...
/
SHOW ERRORS PROCEDURE page_insert_WIT;
