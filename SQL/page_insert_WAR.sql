...
-- en la base de datos con la técnica WAR.
-- Autores:
--
-- Samantha Campisi (samanthac07@gmail.com)
-- Juan A. Escalante (jaescalante02@gmail.com)

CREATE OR REPLACE PROCEDURE page_insert_WAR(pid in number, url in varchar, 
    ...
    BEGIN
        ...
        insert into WAR_PAGINA (P_ID, P_URL)
        values (pid, url);
...
/
SHOW ERRORS PROCEDURE page_insert_WAR;
