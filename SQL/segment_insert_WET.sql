-- segment_insert_WET.sql
--
-- Procedimiento que incluye un segmento a la base de datos con la tecnica WET.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE segment_insert_WET(pid in number, url in varchar, 
...
/
SHOW ERRORS PROCEDURE segment_insert_WET;
