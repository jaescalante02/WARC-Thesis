-- capture_insert_WAR.sql
--
-- Procedimiento que incluye una captura en la base de datos con la técnica WAR.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE capture_insert_WAR(pid in number, url in varchar, 
    ...
    BEGIN
        ...
        insert into WAR_CAPTURA (C_ID, C_CAPTURA, C_FECHA, C_CDX)
        ...
        insert into WAR_SEGMENTO (S_ID, S_CAPTURA, S_SEGID, S_SEGMENTO)
...
/
SHOW ERRORS PROCEDURE capture_insert_WAR;
