-- capture_insert_WIT.sql
--
-- Procedimiento que incluye una captura en la base de datos con la técnica WIT.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE capture_insert_WIT(pid in number, url in varchar, 
    ...
    BEGIN
        ...
        insert into WIT_CAPTURA (C_ID, C_CAPTURA, C_FECHA, C_CDX)
...
/
SHOW ERRORS PROCEDURE capture_insert_WIT;
