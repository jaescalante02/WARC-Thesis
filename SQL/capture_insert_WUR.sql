-- capture_insert_WUR.sql
--
-- Procedimiento que incluye una captura en la base de datos con la técnica WUR.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE capture_insert_WUR(pid in number, url in varchar, 
...
/
SHOW ERRORS PROCEDURE capture_insert_WUR;
