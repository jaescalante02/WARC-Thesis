-- segment_insert_WOT.sql
--
-- Procedimiento que incluye un segmento a la base de datos con la tecnica WOT.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE segment_insert_WOT(pid in number, url in varchar, 
...
/
SHOW ERRORS PROCEDURE segment_insert_WOT;
