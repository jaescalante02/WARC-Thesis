-- segment_insert_WUR.sql
--
-- Procedimiento que incluye un segmento a la base de datos con la tecnica WUR.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE segment_insert_WUR(pid in number, url in varchar, 
...
/
SHOW ERRORS PROCEDURE segment_insert_WUR;
