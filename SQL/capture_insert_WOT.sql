-- capture_insert_WOT.sql
--
-- Procedimiento que incluye una captura en la base de datos con la técnica WOT.
--
-- Autores:
--
...
CREATE OR REPLACE PROCEDURE capture_insert_WOT(pid in number, url in varchar, 
    ...
    BEGIN
        ...
        insert into WOT_CAPTURA (C_ID, C_CAPTURA, C_FECHA, C_CDX)
        ...
        insert into WOT_SEGMENTO (S_ID, S_CAPTURA, S_SEGID, S_SEGMENTO)
    ...
    END;
/
SHOW ERRORS PROCEDURE capture_insert_WOT;
